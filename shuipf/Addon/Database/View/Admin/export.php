...
<div class="wrap J_check_wrap">
    ...
    <table width="100%">
      ...
      <volist name="list" id="vo">
        <tr>
          ...
          <td class="action"><a href="{:U('Database/optimization',array('tables'=>$vo['name'],'isadmin'=>1 ))}">优化表</a>&nbsp; <a href="{:U('Database/repair',array('tables'=>$vo['name'],'isadmin'=>1 ))}">修复表</a></td>
        </tr>
      </volist>
    </table>
  </div>
  <div class="btn_wrap">
      <div class="btn_wrap_pd">
        ...
        <button class="btn J_ajax_submit_btn" type="submit" data-action="{:U('Database/optimization',array('isadmin'=>1 ))}">优化表</button>
        <button class="btn J_ajax_submit_btn" type="submit" data-action="{:U('Database/repair',array('isadmin'=>1 ))}">修复表</button>
      </div>
    </div>
  </form>
</div>
