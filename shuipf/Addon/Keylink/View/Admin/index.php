...
<div class="wrap J_check_wrap">
  ...
  <form class="J_ajaxForm" action="{:U('delete','isadmin=1')}" method="post">
      ...
      <table width="100%">
        ...
        <volist name="data" id="vo">
          <tr>
            ...
            <td align="center"><a href="{:U('edit',array('isadmin'=>1,'keylinkid'=>$vo['keylinkid']))}" class="mr5">[编辑]</a> <a class="J_ajax_del" href="{:U('delete',array('isadmin'=>1,'keylinkid'=>$vo['keylinkid']))}">[删除]</a>
          </tr>
        </volist>
      </table>
      <div class="p10">
